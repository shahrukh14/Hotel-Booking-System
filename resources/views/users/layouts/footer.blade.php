                ...
                <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                    <div class="footer-widget">
                        <div class="single-contact mb-30">
                            ...
                            <a href="tel:+14245239000">+1 (424) 523-9000</a>
                        </div>
                        <div class="single-contact mb-35">
                            ...
                            <a href="mailto:burseystr237@gmail.com">burseystr237@gmail.com</a>
                        </div>
                        <div class="single-contact">
                            ...
                            <a target="_blank"
                               href="https://www.google.com/maps/place/7012+Bursey+Rd,+Fort+Worth,+TX+76182/@32.8918298,-97.2317246,70m/data=!3m1!1e3!4m6!3m5!1s0x864dd7c818ed2e41:0xc599bdbe5529276b!8m2!3d32.891936!4d-97.2316663!16s%2Fg%2F11c4vv6mhq?entry=ttu&g_ep=EgoyMDI0MTEyNC4xIKXMDSoASAFQAw%3D%3D">7012
                                Bursey Road <br> North Richland Hills, Texas 76182</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
                    <div class="footer-widget">
                        ...
                        <div class="payment-partner">
                            ...
                            <div class="icons">
                                <ul>
                                    <li><img loading="lazy" src="{{ asset('assets/img/home1/icon/visa-logo.svg')}}" alt=""></li>
                                    <li><img loading="lazy" src="{{ asset('assets/img/home1/icon/stripe-logo.svg')}}" alt=""></li>
                                    <li><img loading="lazy" src="{{ asset('assets/img/home1/icon/paypal-logo.svg')}}" alt=""></li>
                                    <li><img loading="lazy" src="{{ asset('assets/img/home1/icon/woo-logo.svg')}}" alt=""></li>
                                    <li><img loading="lazy" src="{{ asset('assets/img/home1/icon/skrill-logo.svg')}}" alt=""></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="row">
                <div class="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                    ...
                    <p>Developed By <a href="https://omnidigiverse.com/" target="_blank">Omni Digiverse</a></p>
